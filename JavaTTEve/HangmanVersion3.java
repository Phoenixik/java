...
public class HangmanVersion3
{
    //Instance variable
    String word[] = {"japan", "qatar", "syria", "mongolia", "bahrain", "india","nigeria","ghana"};
    ...
    public void playGame() 
    {
		...
		rnd = rd.nextInt(8); 
		/* generates a random number between -1 and 7 and assigns the same to the variable rnd */
    ...
    {
        HangmanVersion3 Keys = new HangmanVersion3();
		Keys.showMenu();
    }	
}
